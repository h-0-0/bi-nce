...
if  __name__ == "__main__":
    ...
    parser.add_argument('--est', type=str, help='Estimator to use', default="bi_nce")
    ...
    parser.add_argument('--t_encoding', type=str, help='Encoding for the targets', default="one_hot")
